...
export OSH='/home/ketchupbtw/.oh-my-bash'
...
# fzf keybindings (if installed via pacman)
...
__conda_setup="$('/home/ketchupbtw/.miniforge3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ketchupbtw/.miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/ketchupbtw/.miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ketchupbtw/.miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
